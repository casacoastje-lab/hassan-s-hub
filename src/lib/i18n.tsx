...
const translations: Record<Language, Record<string, string>> = {
  ...
  fr: {
    ...
    'hero.intro': 'Développeur full-stack & étudiant en génie logiciel construisant des applications web évolutives et des systèmes d\'automatisation IA. Fondateur d\'un club tech universitaire. Basé à Nanchong, Chine.',
    ...
    'about.text1': 'Je suis étudiant en génie logiciel et développeur full-stack avec une expérience pratique dans la création d\'applications web évolutives, de systèmes d\'automatisation IA et de produits SaaS. Je transforme les idées en produits numériques fonctionnels.',
    ...
    'about.text3': 'Maîtrisant React.js, Node.js, Supabase et les outils d\'IA/automatisation (n8n, prompt engineering), je recherche activement un stage en ingénierie logicielle ou en développement de produits IA.',
    ...
    'experience.freelance.1': 'Conception et livraison de 10+ sites web et applications en production avec React.js, Node.js, Supabase et Tailwind CSS',
    'experience.freelance.2': 'Gestion complète du cycle de vie des projets : exigences, architecture, codage, tests, déploiement',
    'experience.freelance.3': 'Conception et déploiement d\'automatisations IA avec n8n, intégrant plusieurs API d\'IA pour améliorer l\'efficacité opérationnelle',
  ...
  ar: {
    ...
    'hero.intro': 'مطور ويب شامل وطالب هندسة برمجيات أبني تطبيقات ويب قابلة للتوسع وأنظمة أتمتة مدعومة بالذكاء الاصطناعي. مؤسس نادي تقني جامعي. مقيم في نانتشونغ، الصين.',
    ...
    'about.text1': 'أنا طالب هندسة برمجيات ومطور ويب شامل ولدي خبرة عملية في بناء تطبيقات ويب قابلة للتوسع وأنظمة أتمتة مدعومة بالذكاء الاصطناعي ومنتجات SaaS. أحول الأفكار إلى منتجات رقمية نظيفة وعملية.',
    ...
    'about.text3': 'بإتقاني لـ React.js وNode.js وSupabase وأدوات الذكاء الاصطناعي/الأتمتة (n8n، هندسة الأوامر)، أبحث بنشاط عن تدريب في هندسة البرمجيات أو تطوير منتجات الذكاء الاصطناعي.',
    ...
    'experience.freelance.1': 'تصميم وتسليم أكثر من 10 مواقع وتطبيقات ويب إنتاجية باستخدام React.js وNode.js وSupabase وTailwind CSS',
    'experience.freelance.2': 'إدارة دورة حياة المشروع بالكامل بشكل مستقل: المتطلبات، الهندسة، البرمجة، الاختبار، النشر',
    'experience.freelance.3': 'تصميم ونشر أتمتة سير العمل بالذكاء الاصطناعي باستخدام n8n ودمج عدة واجهات برمجة ذكاء اصطناعي لتعزيز الكفاءة',
